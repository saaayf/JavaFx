...
public class ClaimsController {
    ...
    private void handleButtonClicks(javafx.event.ActionEvent mouseEvent) {
        if (mouseEvent.getSource() == AddOffer) {
            loadStage("/com/Skillseekr/Claims/addReclamation.fxml");
        }
    }
    ...
    @FXML
    void handleClaims(MouseEvent event) {
        try {
            AnchorPane showOfferPane = FXMLLoader.load(getClass().getResource("/com/Skillseekr/Claims/showReclamation.fxml"));
            contentPane.getChildren().setAll(showOfferPane);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    @FXML
    void handleResponse(MouseEvent event) {
        try {
            AnchorPane showOfferPane = FXMLLoader.load(getClass().getResource("/com/Skillseekr/Claims/showResponse.fxml"));
            contentPane.getChildren().setAll(showOfferPane);
        } catch (IOException e) {
            e.printStackTrace();
        }
